...
local TEMP_SOURCE_IDS = { "cpu", "wifi", "modem", "nvme" }
...
local function status_payload()
    ...
    return {
        ...
        sources = {
            ...
            { id = "wifi", state = "missing", temp = nil },
            { id = "modem", state = "missing", temp = nil },
            { id = "nvme", state = "missing", temp = nil }
        }
    }
end
