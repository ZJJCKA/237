		...
		s.addModalOptions = function(s) {
			return network.getWifiNetwork(s.section).then(function(radioNet) {
				...
				if (hwtype == 'mac80211') {
					...
					o = ss.taboption('advanced', form.Flag, 'ieee80211v', _('802.11v BSS Transition'), _('Requires a compatible roaming controller; keep disabled on a single access point'));
					o.default = o.disabled;
					o.depends('mode', 'ap');

					o = ss.taboption('advanced', form.Value, 'pmk_cache_period', _('PMK cache period'), _('Minutes; 720 keeps cached keys for 12 hours'));
					o.optional = true;
					o.placeholder = 720;
					o.datatype = 'range(10,43200)';
					o.depends('mode', 'ap');
