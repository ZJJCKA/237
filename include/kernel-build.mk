...
# Keep Linux 5.4 image-only MODPOST output away from the full provider table.
KERNEL_MAKEOPTS_IMAGE += kernelsymfile=$(LINUX_DIR)/vmlinux.symvers
...
define BuildKernel
  ...
  $(KERNEL_BUILD_DIR)/symtab.h: FORCE
	...
	+$(KERNEL_MAKE) kernelsymfile=$(LINUX_DIR)/vmlinux.symvers vmlinux
